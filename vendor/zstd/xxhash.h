...
#define XXH_VECTOR XXH_SSE2
    ...
    (defined(__s390x__) && defined(__VEC__)) && defined(__GNUC__)
...
#if XXH_VECTOR == XXH_AVX2 && defined(__GNUC__) && !defined(__clang__) &&      \
...
XXH_FORCE_INLINE xxh_u64 XXH3_mix16B(const xxh_u8 *XXH_RESTRICT input,
    ...
    defined(__SSE2__) && !defined(XXH_ENABLE_AUTOVECTORIZE)
...
XXH_FORCE_INLINE XXH_TARGET_AVX512 XXH3_ACCUMULATE_TEMPLATE(avx512)
  ...
  XXH_STATIC_ASSERT(XXH_STRIPE_LEN == sizeof(__m512i));
  {
    ...
    __m512i const data_key =
        _mm512_ternarylogic_epi32(key_vec, acc_vec, shifted, 0x96);
...
XXH3_accumulate_512_scalar(void *XXH_RESTRICT acc,
  ...
  size_t i;
    ...
    defined(__ARM_FEATURE_UNALIGNED) && XXH_SIZE_OPT <= 0
#pragma GCC unroll 8
#endif
...
#if defined(__clang__) && (defined(__arm__) || defined(__thumb__)) &&          \
