...
void print_gzip_header(struct isal_gzip_header *gz_hdr, char *prepend1,
                       char *prepend2) {
...
int write_gzip_header(uint8_t *hdr_buf, uint32_t hdr_buf_len,
                      struct isal_gzip_header *gz_hdr) {
...
int write_zlib_header(uint8_t *hdr_buf, uint32_t hdr_buf_len,
                      struct isal_zlib_header *z_hdr) {
  struct isal_zstream stream;
...
int compare_gzip_headers(struct isal_gzip_header *gz_hdr1,
                         struct isal_gzip_header *gz_hdr2) {
  int ret = 0;
  uint32_t max_len;
...
int compare_zlib_headers(struct isal_zlib_header *z_hdr1,
                         struct isal_zlib_header *z_hdr2) {
