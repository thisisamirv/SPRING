...
#pragma omp parallel
  {
    ...
    spring::bsc::BSC_decompress((file_name + ".bsc").c_str(),
                                (file_name + ".decomp").c_str());
  }
  ...
  spring::bsc::BSC_str_array_compress("def", str_array, 2000, str_lengths, 127);
  std::string *str_array_1 = new std::string[2000];
  spring::bsc::BSC_str_array_decompress("def", str_array_1, 2000, str_lengths);
