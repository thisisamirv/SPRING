...
#include <string>
#include <vector>
void fun_1(std::string &infile);
void fun_2(std::string &infile, std::string &infile_2);
void fun_3(std::string &infile, std::string &infile_2, int block_size);
void fun_4();
void fun_5(std::string &infile, int block_size);
