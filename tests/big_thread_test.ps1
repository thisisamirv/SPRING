...
$SPRING_BIN = ".\build\spring2.exe"
$INPUT_R1 = ".\tests\output\input\SRR8185389_1.fastq.gz"
$INPUT_R2 = ".\tests\output\input\SRR8185389_2.fastq.gz"
$OUTPUT_DIR = ".\tests\output\thread_test"
