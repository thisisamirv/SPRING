...
1. ATAC promoter block (ATAC vs non-ATAC discrimination)
...
1. Intron / intergenic control block (background normalization)
...
1. Genome backbone block (fragment geometry and periodicity)
